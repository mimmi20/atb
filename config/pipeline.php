...
//    $app->pipe(ReferrerSpam::class);
//    $app->pipe(TrailingSlash::class);
//    $app->pipe(Lowercase::class);
//    $app->pipe(ClientIp::class);
//    $app->pipe(SetLocaleMiddleware::class);
//
//    $app->pipe(path('/admin', $factory->prepare('admin-pipeline')));
//    $app->pipe(path('/', $factory->prepare('default-pipeline')));
//    $app->pipe(host('admin.example.org', path('/admin', $factory->prepare('admin-pipeline'))));
};
